...
- `.qwen/rules/commit-style.md` -- Conventional Commits 1.0.0 风格
- `.qwen/rules/no-history-rewrite.md` -- 已推送分支禁止改写历史
- `.qwen/rules/test-requirements.md` -- 改 transformer / runner / writer / parser 必带 _test.go 防回归  (applyTo: `internal/transformer/**/*.go, internal/runner/**/*.go, internal/writer/**/*.go, internal/parser/**/*.go`)
