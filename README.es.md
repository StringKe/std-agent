...
![std-agent: una única fuente de verdad para 26 herramientas de CLI de IA](docs/assets/hero.png)
...
`stdagent` es una CLI ligera y escrita en Go puro que mantiene un único directorio `.stdai/` como fuente de verdad para la configuración de IA de tu proyecto, y luego la distribuye a **26 herramientas de CLI de IA** gestionando por ti sus formatos de archivo nativos, dialectos de frontmatter y particularidades.
...
- **Veintiséis destinos** -- Claude Code, Codex, Cursor, GitHub Copilot, Windsurf/Devin, Gemini CLI, Aider, Cline, OpenCode, Crush, Amp, Warp, Factory, Junie, Antigravity, Qwen Code, Pi, Kilo Code, Augment Code, Jules, Grok Build, Kimi Code, Kiro, Goose, Zed, Muse Code (Meta).
...
- **[docs/spec.md](docs/spec.md)** -- especificación completa: estándar std-agent + divergencia de las 26 herramientas + estrategia de conversión
