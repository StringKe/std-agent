...
- @.claude/rules/commit-style.md -- Conventional Commits 和安全暂存要求
- @.claude/rules/no-history-rewrite.md -- 保护已推送分支和 release tag
- @.claude/rules/test-requirements.md -- 核心转换与写入变更必须有针对性回归测试  (applyTo: `internal/transformer/**/*.go, internal/runner/**/*.go, internal/writer/**/*.go, internal/parser/**/*.go`)
