...
下列条目由 stdagent 同步到 `.github/instructions/`，AI 按 description / applyTo 判断是否相关后用 Read 工具读取具体内容：

- `.github/instructions/test-requirements.instructions.md` -- 改 transformer / runner / writer / parser 必带 _test.go 防回归  (applyTo: `internal/transformer/**/*.go, internal/runner/**/*.go, internal/writer/**/*.go, internal/parser/**/*.go`)
