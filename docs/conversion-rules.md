...
stdagent 将统一 source 转换为 26 个 AI CLI target 的原生配置。本文只定义跨 target 的稳定契约；具体路径、字段和限制以 [targets/](targets/) 的官方证据及对应 adapter 为准。
...
|---|---|---|
| `AgentsMD` | codex, amp, warp, factory, jules, grok-build, kimi-code, kiro, goose, junie, zed, muse | `AGENTS.md` plus target sidecars |
