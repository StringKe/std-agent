...
<!-- Target tool "continue-dev" does not natively support this type. Skill is an on-demand capability pack; AI loads it when the description matches user intent. -->
