...
![std-agent : une seule source de vérité pour 22 outils CLI IA](docs/assets/hero.png)
...
- **Vingt-deux cibles** -- Claude Code, Codex, Cursor, GitHub Copilot, Windsurf/Devin, Gemini CLI, Aider, Cline, OpenCode, Roo Code, Crush, Amp, Warp, Factory, Continue.dev, Antigravity, Qwen Code, Pi, Kilo Code, Augment Code, Jules, Grok Build.
...
- **[docs/spec.md](docs/spec.md)** -- spec complète : standard std-agent + divergences des 22 outils + stratégie de conversion
